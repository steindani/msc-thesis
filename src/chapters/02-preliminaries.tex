...
\Cref{fig:processing-the-source-code} shows the general process for processing source codes---how it is transformed from a stream of characters into a data structure with ``meaning''.
